...
<html lang="en">
    <head>
        ...
        <title>B2B Agent</title>

        <link rel="stylesheet" href="<?php echo e(asset('b2b')); ?>/css/bootstrap.min.css">
        <link rel="stylesheet" href="<?php echo e(asset('b2b')); ?>/css/font-awesome.min.css">
        <link rel="stylesheet" href="<?php echo e(asset('b2b')); ?>/css/owl.carousel.css">
        <link rel="stylesheet" href="<?php echo e(asset('b2b')); ?>/css/owl.theme.css">
        <link rel="stylesheet" href="<?php echo e(asset('b2b')); ?>/css/animate.css">
        <link rel="stylesheet" href="<?php echo e(asset('b2b')); ?>/css/flexslider.css">
        <link rel="stylesheet" href="<?php echo e(asset('b2b')); ?>/css/pricing.css">
        <link rel="stylesheet" href="<?php echo e(asset('b2b')); ?>/css/main.css">


        <script src="<?php echo e(asset('b2b')); ?>/js/jquery-1.11.2.min.js"></script>
        <script type="text/javascript" src="<?php echo e(asset('b2b')); ?>/js/jquery.flexslider.min.js"></script>
    ...
    <body data-spy="scroll" data-target="#template-navbar">
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">
                        <img id="logo"  class="logo img-responsive">
                    </a>
                </div>
        ...
        <section id="about" class="about">
            <img src="<?php echo e(asset('b2b')); ?>/images/icons/about_color.png" class="img-responsive section-icon hidden-sm hidden-xs">
            <div class="wrapper">
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <ul id="menu-pricing" class="menu-price">
                                <li class="item dinner">
                                    ...
                                    <a href="#">
                                        <img src="<?php echo e(asset('b2b')); ?>/images/food1.jpg" class="img-responsive" alt="Food" >
                                ...
                                <li class="item breakfast">
                                    ...
                                    <a href="#">
                                        <img src="<?php echo e(asset('b2b')); ?>/images/food2.jpg" class="img-responsive" alt="Food" >
                                        <div class="menu-desc">
                                            <span>
                                                <h3>Prawn Dish</h3>
                                ...
                                <li class="item desert">
                                    ...
                                    <a href="#">
                                        <img src="<?php echo e(asset('b2b')); ?>/images/food3.jpg" class="img-responsive" alt="Food" >
                                        <div class="menu-desc">
                                            <span>
                                                <h3>Salad Dish</h3>
                                ...
                                <li class="item breakfast special">
                                    ...
                                    <a href="#">
                                        <img src="<?php echo e(asset('b2b')); ?>/images/food4.jpg" class="img-responsive" alt="Food" >
                                        <div class="menu-desc">
                                            <span>
                                                <h3>Prawn Dish</h3>
                                ...
                                <li class="item breakfast">
                                    ...
                                    <a href="#">
                                        <img src="<?php echo e(asset('b2b')); ?>/images/food5.jpg" class="img-responsive" alt="Food" >
                                        <div class="menu-desc">
                                            <span>
                                ...
                                <li class="item dinner special">
                                    ...
                                    <a href="#">
                                        <img src="<?php echo e(asset('b2b')); ?>/images/food6.jpg" class="img-responsive" alt="Food" >
                                        <div class="menu-desc">
                                            <span>
                                                <h3>Chicken Dish</h3>
                                ...
                                <li class="item desert">
                                    ...
                                    <a href="#">
                                        <img src="<?php echo e(asset('b2b')); ?>/images/food7.jpg" class="img-responsive" alt="Food" >
                                        <div class="menu-desc">
                                            <span>
                                ...
                                <li class="item dinner">
                                    ...
                                    <a href="#">
                                        <img src="<?php echo e(asset('b2b')); ?>/images/food8.jpg" class="img-responsive" alt="Food" >
                                        <div class="menu-desc">
                                            <span>
                                                <h3>Special Salad</h3>
                                ...
                                <li class="item desert special">
                                    ...
                                    <a href="#">
                                        <img src="<?php echo e(asset('b2b')); ?>/images/food9.jpg" class="img-responsive" alt="Food" >
                                        <div class="menu-desc">
                                            <span>
                                                <h3>Ice-cream</h3>
        ...
        <section id="great-place-to-enjoy" class="great-place-to-enjoy">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="<?php echo e(asset('b2b')); ?>/images/icons/beer_black.png">
            <div class="wrapper">
                <div class="container-fluid">
                    <div class="row dis-table">
        ...
        <section id="beer" class="beer">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="<?php echo e(asset('b2b')); ?>/images/icons/beer_color.png">
            <div class="container-fluid">
                <div class="row dis-table">
        ...
        <section id="breakfast" class="breakfast">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="<?php echo e(asset('b2b')); ?>/images/icons/bread_black.png">
            <div class="wrapper">
                <div class="container-fluid">
                    <div class="row dis-table">
                        <div class="col-xs-6 col-sm-6 dis-table-cell color-bg">
        ...
        <section id="bread" class="bread">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="<?php echo e(asset('b2b')); ?>/images/icons/bread_color.png">
            <div class="container-fluid">
                <div class="row dis-table">
                    <div class="hidden-xs col-sm-6 dis-table-cell section-bg">
        ...
        <section id="featured-dish" class="featured-dish">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="<?php echo e(asset('b2b')); ?>/images/icons/food_black.png">
            <div class="wrapper">
                <div class="container-fluid">
                    <div class="row dis-table">
                        <div class="col-xs-6 col-sm-6 dis-table-cell color-bg">
        ...
        <section id="have-a-look" class="have-a-look hidden-xs">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="<?php echo e(asset('b2b')); ?>/images/icons/food_color.png">
            <div class="wrapper">
                <div class="container-fluid">
                    <div class="row">
        ...
        <section id="reserve" class="reserve">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="<?php echo e(asset('b2b')); ?>/images/icons/reserve_black.png">
            <div class="wrapper">
                <div class="container-fluid">
                    <div class="row dis-table">
                        <div class="col-xs-6 col-sm-6 dis-table-cell color-bg">
        ...
        <section class="reservation">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="<?php echo e(asset('b2b')); ?>/images/icons/reserve_color.png">
            <div class="wrapper">
                <div class="container-fluid">
                    <div class=" section-content">
                        <div class="row">
        ...
        <script src="<?php echo e(asset('b2b')); ?>/js/bootstrap.min.js"></script>
        <script src="<?php echo e(asset('b2b')); ?>/js/owl.carousel.min.js"></script>
        <script type="text/javascript" src="<?php echo e(asset('b2b')); ?>/js/jquery.mixitup.min.js" ></script>
        <script src="<?php echo e(asset('b2b')); ?>/js/wow.min.js"></script>
        <script src="<?php echo e(asset('b2b')); ?>/js/jquery.validate.js"></script>
        <script type="text/javascript" src="<?php echo e(asset('b2b')); ?>/js/jquery.hoverdir.js"></script>
        <script type="text/javascript" src="<?php echo e(asset('b2b')); ?>/js/jQuery.scrollSpeed.js"></script>
        <script src="<?php echo e(asset('b2b')); ?>/js/script.js"></script>
        

    </body>
</html><?php /**PATH G:\19-2\ATP-3\travel\resources\views/b2b/index.blade.php ENDPATH**/ ?>